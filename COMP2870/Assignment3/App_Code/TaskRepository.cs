...
public class TaskRepository
{
    ...
    public int AddTask(Task task)
    {
        ...
        {
            string commandText = "INSERT INTO Task VALUES (@Name, @CategoryId, @StartDate, @DueDate, @Completed, @Priority, @PercentComplete, @UserName)";
    ...
    public static int[] GetValidPriorities()
    {
        return new[]{1, 2, 3};        
    }
